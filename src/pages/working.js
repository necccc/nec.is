  ...
  >
    <article className={css.resumeContainer}>
      ...
      <div className={css.resumeSection}>
        <ul>
          ...
          <li>
            ...
            npm, linux systems, git/github/gitlab, Docker, Chef, Kubernetes,
            Tekton CI/CD, Hashicorp Vault, TravisCI, TeamCity
          </li>
        </ul>
      </div>
      ...
      <div className={css.resumeSection}>
        ...
        <h4>
          BinX • <em>2022 - present</em>
        </h4>
        <ul>
          <li>
            Work with the engineering team and business development to create a
        ...
        <h4>
          IBM Cloud Video (formerly Ustream, acquired by IBM) •{' '}
          <em>2016 - 2019</em>
        </h4>
        <ul>
          <li>
            Finding solutions to a backend-for-frontend system using React, to
            feature i18n, SSR, code splitting and Redux state management
          </li>
          ...
          <li>
            Developed and participated in the design process of a Caption Editor
            for both Cloud Video and Watson Media
          </li>
          <li>
        ...
        <h3>Senior Frontend Engineer</h3>
        <h4>
          Ustream Inc, startup • <em>2009 - 2016</em>
        </h4>
        <ul>
          <li>
            Early development of mobile video/live player, with ad integration
          </li>
          <li>
            Embedable player for both mobile and desktop (core desktop player
            was flash based by another team)
          </li>
          <li>
            Created core interactive modules like chat, social message wall
          </li>
          <li>
            Helped desiging, and creating a custom MVC framework for the site JS
            codebase
          </li>
          <li>
            Finished several iterations on the whole site design together with
            the team
          </li>
        ...
        <h4>
          Carnation (later it was acquired by POSSIBLE), digital agency •{' '}
          <em>2007 - 2009</em>
        </h4>
        <ul>
      ...
      <div className={css.resumeSection}>
        ...
        <ul>
          ...
          <li>
            My participation was in organizing venue, catering, hotel and flight
            arrangements and sponsor negotiations
          </li>
        </ul>
